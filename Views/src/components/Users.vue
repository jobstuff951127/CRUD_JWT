...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Adress", value: "Adress", sortable: false, align: "left" },
      { text: "BirthDate", value: "BirthDate", sortable: false, align: "left" },
    ],
    search: "",
    editedIndex: -1,
  }),
  ...
  methods: {
    ...
    async updateCondition() {
      ...
      setTimeout(() => {
        agent.Categories.updateCondition(this.form)
          .then((response) => {
    ...
    async save() {
      ...
      setTimeout(() => {
        if (this.editedIndex > -1) {
          agent.Categories.update(this.form)
            .then((response) => {
              if (response.status === 200) {
